...
**데이터:** 스팀 리뷰 수를 판매량 대리변수로 사용 (Boxleiter 원재료). 코호트 A(코옵) n=329, 코호트 B(싱글 내러티브) n=754, 코호트 R(로그라이크) n=663 (리뷰 ≥10, 유료, <$40, 2022-01~2025-12 출시). 코호트는 상호배타적이며 분류 우선순위는 A(코옵) > R(로그라이크) > B(내러티브).

## 가설 1 — 더 무거운 꼬리 (α_coop < α_single): **기각/불확정**

| 코호트 | n | α | SE | xmin | n_tail | PL vs LN (R, p) |
|---|---|---|---|---|---|---|
| 코옵 | 329 | 1.389 | 0.024 | 28 | 264 | R=-1.84, p=0.066 |
| 싱글 내러티브 | 754 | 1.681 | 0.047 | 282 | 214 | R=-1.83, p=0.067 |
| 로그라이크 | 663 | 1.490 | 0.020 | 15 | 581 | R=-1.96, p=0.050 |

- α 차이 (A − B): **-0.292**, 부트스트랩 95% CI [-0.676, 0.085] (500회 리샘플)
- α 차이 (A − R): -0.100, 95% CI [-0.337, 0.099]
- α 차이 (R − B): -0.191, 95% CI [-0.553, 0.214]
...
|---|---|---|---|
| 코옵 | 0.292 (96/329) | 0.0186 | 0.639 |
| 싱글 내러티브 | 0.302 (228/754) | 0.0161 | 0.209 |
| 로그라이크 | 0.262 (174/663) | 0.0147 | 0.458 |

- 중간 구간 비율 차이: χ²=0.08, p=0.781; Fisher OR=0.951, p=0.773
...
|---|---|---|---|---|---|---|---|
| 코옵 | 107 | 8,734 (×82) | 194 | 0.954 [0.906, 0.968] | 64.6% | 88.6% | 29.1% (135/464) |
| 싱글 내러티브 | 70 | 967 (×14) | 107 | 0.877 [0.849, 0.896] | 36.2% | 70.2% | 28.3% (297/1051) |
| 로그라이크 | 49 | 1,490 (×30) | 85 | 0.934 [0.896, 0.949] | 55.6% | 85.9% | 34.8% (354/1017) |

- 조기 소멸률 차이: χ²=0.07, p=0.787
...
|---|---|---|---|
| $5-10 | 1.46 (101) | 2.02 (188) | 예 |

**연도별 α:**

| 연도 | α_coop (n) | α_single (n) |
|---|---|---|
| 2024 | 1.37 (121) | 2.37 (231) |
...
|---|---|---|
| 코옵 | 1.418 (0.032) | 169 |
| 싱글 내러티브 | 1.550 (0.031) | 324 |
| 로그라이크 | 1.542 (0.035) | 239 |

**코호트 B 대안 정의 민감도:**

| 정의 | n | α | Gini |
|---|---|---|---|
| broad_or_sr_adv_puz | 1814 | 1.54 | 0.888 |
| adventure_only | 1314 | 1.53 | 0.891 |
| puzzle_only | 694 | 1.63 | 0.891 |
| A_reference | 329 | 1.39 | 0.954 |
...
|---|---|---|---|---|---|
| 2022 | 157 | 118 | 113 | ×1.4 | ×1.0 |
| 2023 | 206 | 88 | 123 | ×1.7 | ×0.7 |
| 2024 | 234 | 75 | 100 | ×2.3 | ×0.7 |
| 2025 | 156 | 71 | 88 | ×1.8 | ×0.8 |
