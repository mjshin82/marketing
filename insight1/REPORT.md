...
**데이터:** 스팀 리뷰 수를 판매량 대리변수로 사용 (Boxleiter 원재료). 코호트 A(코옵) n=116, 코호트 B(싱글 내러티브) n=582, 코호트 R(로그라이크) n=205 (리뷰 ≥10, 유료, <$40, 2022-01~2025-06 출시). 코호트는 상호배타적이며 분류 우선순위는 A(코옵) > R(로그라이크) > B(내러티브).

## 가설 1 — 더 무거운 꼬리 (α_coop < α_single): **기각/불확정**

| 코호트 | n | α | SE | xmin | n_tail | PL vs LN (R, p) |
|---|---|---|---|---|---|---|
| 코옵 | 116 | 1.811 | 0.169 | 12217 | 23 | R=-0.24, p=0.811 |
| 싱글 내러티브 | 582 | 1.472 | 0.020 | 11 | 562 | R=-1.36, p=0.172 |
| 로그라이크 | 205 | 1.365 | 0.026 | 10 | 205 | R=-1.66, p=0.097 |

- α 차이 (A − B): **0.339**, 부트스트랩 95% CI [-0.248, 0.915] (500회 리샘플)
- α 차이 (A − R): 0.446, 95% CI [-0.164, 1.002]
- α 차이 (R − B): -0.107, 95% CI [-0.162, -0.035]
...
|---|---|---|---|
| 코옵 | 0.241 (28/116) | 0.0331 | 0.499 |
| 싱글 내러티브 | 0.186 (108/582) | 0.0189 | 0.174 |
| 로그라이크 | 0.234 (48/205) | 0.0164 | 0.989 |

- 중간 구간 비율 차이: χ²=1.58, p=0.209; Fisher OR=1.396, p=0.199
...
|---|---|---|---|---|---|---|---|
| 코옵 | 358 | 22,505 (×63) | 576 | 0.917 [0.818, 0.943] | 59.9% | 77.7% | 20.0% (29/145) |
| 싱글 내러티브 | 40 | 1,234 (×31) | 81 | 0.907 [0.887, 0.920] | 32.8% | 74.9% | 36.3% (332/914) |
| 로그라이크 | 66 | 3,656 (×55) | 147 | 0.911 [0.865, 0.932] | 43.2% | 73.9% | 29.8% (87/292) |

- 조기 소멸률 차이: χ²=14.12, p=1.71e-04
...
| 정의 | n | α | Gini |
|---|---|---|---|
| story_rich_only | 238 | 1.38 | 0.883 |
| puzzle_only | 221 | 1.56 | 0.921 |
| A_reference | 116 | 1.81 | 0.917 |
