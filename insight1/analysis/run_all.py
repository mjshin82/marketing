...
def write_report():
    ...
    lines = [
        ...
        + " (판매 ≥500장, 유료, <$40, 2022-01~2026-06 출시, AAA 제외). "
    ...
    lines += [
        ...
        "- **생존 편향 (방향 불확실):** 상장폐지된 게임은 스팀 공식 API에서 조회 불가라 "
        "제외되어 모든 코호트의 조기 소멸률이 과소추정된다. 온라인 코옵은 매칭이 죽으면 "
        "상품성이 사라져 내려갈 유인이 있어 코옵 지표가 위로 편향될 수 있으나, 반대로 "
        "스팀 P2P 기반 코옵은 서버 유지비가 없어 죽은 게임을 내릴 유인도 낮다 — 편향의 "
        "실제 크기와 방향은 불확실하다.",
